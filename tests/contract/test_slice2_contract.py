...
# register an adapter. S2.5 graduated Greenhouse, S2.6 Lever, S2.7 Ashby;
# the S2.8 corrective adds the minimal durable §12.1 generic-discovery planner
# (not the ROAD-04 generic crawler/frontier).
